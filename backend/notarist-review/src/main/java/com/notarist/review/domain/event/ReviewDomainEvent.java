...
/**
 * Base for every event raised by the OCR Review context. Implements the core {@link DomainEvent}
 * contract — correlation and trace IDs travel on every event, as they do across the rest of the
 * platform.
 *
 * <p>Events are facts in the past tense: they carry identity plus the minimum a consumer needs, never
 * a whole aggregate.
 */
public abstract class ReviewDomainEvent implements DomainEvent {
    ...
    protected ReviewDomainEvent(CorrelationId correlationId, TraceId traceId) {
    ...
    @Override public String publishedBy()          { return "notarist-review"; }
}
