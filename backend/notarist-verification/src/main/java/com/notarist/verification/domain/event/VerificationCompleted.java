...
/** Raised when a verification reaches VERIFIED — every mandatory check passed or was N/A. */
public final class VerificationCompleted extends VerificationDomainEvent {
    ...
    public VerificationCompleted(VerificationId verificationId, BundleId bundleId, UUID tenantId,
    ...
    @Override public String eventType() { return "VERIFICATION_COMPLETED"; }
