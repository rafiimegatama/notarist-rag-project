 ...
 * names are identical to the Verification-context Role names by design, so this is a 1:1 map from the
 * JWT's highest role — no new claim, no change to authentication.
 *
 ...
 */
@Component("verificationCallerContextResolver")
