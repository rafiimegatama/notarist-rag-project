...
/** Raised when a verification is marked FAILED. */
public final class VerificationFailed extends VerificationDomainEvent {
    ...
    public VerificationFailed(VerificationId verificationId, BundleId bundleId, UUID tenantId,
    ...
    @Override public String eventType() { return "VERIFICATION_FAILED"; }
